...
# 3. https://github.com/GregHilston/toolbox/blob/master/nixos/modules/programs/gui/firefox/default.nix
...

{
  programs.firefox = {
    ...
    #     isDefault = true;
    #     settings = {
    #       "browser.startup.homepage" = "https://status.profec.net/status/all";
    ...
    #     search = {
    #       force = true;
    #       default = "duckduckgo"; # https://duckduckgo.com
